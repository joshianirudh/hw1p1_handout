...
from autograder.hw1p1_autograder_flags import *
...
if DEBUG_AND_GRADE_TANH:
    def mock_tanh(*args, **kwargs):
        raise RuntimeError("np.tanh() was called!")
    ...
    try:
        ...
        TEST_tanh_no_np_tanh = True

    except RuntimeError as e:

        TEST_tanh_no_np_tanh = False

    finally:

        np.tanh = original_tanh

    print("\n──────────────────────────────────────────")
    print("TANH | TEST RESULTS 2")
    print("──────────────────────────────────────────")

    print("\n           Pass?")
    print("No np.tanh():", TEST_tanh_no_np_tanh)
...
if DEBUG_AND_GRADE_SOFTMAX:
    print("\n──────────────────────────────────────────")
    print("SOFTMAX | STUDENT OUTPUT | TEST CASE 1")
    print("──────────────────────────────────────────")
    ...
    print("\n──────────────────────────────────────────")
    print("SOFTMAX | SOLUTION OUTPUT | TEST CASE 1")
    print("──────────────────────────────────────────")
    ...
    print("\n──────────────────────────────────────────")
    print("SOFTMAX | CLOSENESS TEST RESULT | TEST CASE 1")
    print("──────────────────────────────────────────")
...
if DEBUG_AND_GRADE_SOFTMAX:
    print("\n──────────────────────────────────────────")
    print("SOFTMAX | STUDENT OUTPUT | TEST CASE 2")
    print("────────────────────────────────────────────")

    softmax = Softmax()

    Z_large = np.array([[1000, 1001, 1002], [12345, 12346, 12347]], dtype="f")
    A_large = softmax.forward(Z_large)
    print("\nA =\n", A_large, sep="")

    dLdA_large = np.array([[1.0, -1.0, 2.0], [0.5, 0.5, -1.0]], dtype="f")
    dLdZ_large = softmax.backward(dLdA_large)
    print("\ndLdZ =\n", dLdZ_large, sep="")

    print("\n──────────────────────────────────────────")
    print("SOFTMAX | SOLUTION OUTPUT | TEST CASE 2")
    print("────────────────────────────────────────────")

    A_large_solution = np.array([[0.09, 0.24473, 0.66524],
                                 [0.09, 0.24473, 0.66524]])
    print("\nA =\n", A_large_solution, "\n", sep="")


    dLdZ_large_solution = np.array([[-0.0158, -0.5325, 0.5483],
                                 [0.0898, 0.2442, -0.334]])

    print("\ndLdZ =\n", dLdZ_large_solution, sep="")

    print("\n──────────────────────────────────────────────")
    print("SOFTMAX | CLOSENESS TEST RESULT | TEST CASE 2")
    print("────────────────────────────────────────────────")

    print("\n           Pass?")

    TEST_softmax_A_large = np.allclose(A_large.round(4), A_large_solution, atol=atol_threshold)
    print("Test A_large:", TEST_softmax_A_large)

    TEST_softmax_dLdZ_large = np.allclose(dLdZ_large.round(4), dLdZ_large_solution, atol=atol_threshold)
    print("Test dLdZ_large:", TEST_softmax_dLdZ_large)
else:
    TEST_softmax_A_large = False
    TEST_softmax_dLdZ_large = False
...
TEST_activations = (
    ...
    TEST_tanh_A and
    TEST_tanh_dLdZ and
    TEST_tanh_no_np_tanh and
    TEST_relu_A and
    TEST_relu_dLdZ and
    TEST_gelu_A and
    TEST_gelu_dLdZ and
    TEST_softmax_A and
    TEST_softmax_dLdZ and
    TEST_softmax_A_large and
    TEST_softmax_dLdZ_large)
